...
<details>
  ...
  <ul>
    <li>실시간 코드 리뷰(채팅 기능) 구현</li>
    <li>홈페이지 틀 구현</li>
    <li>회원 가입 및 로그인 기능 구현</li>
    <li>관리자 페이지 기능 구현</li>
    <li>FrontEnd 프로젝트 배포</li>
  </ul>
</details>
<details>
  <summary> 남소희 [FE]</summary>
  <ul>
    <li>코드 편집기 IDE 기능 구현</li>
    <li>스터디 페이지 구현</li>
    <li>카테고리 페이지 구현</li>
    <li>알고리즘 설명 페이지 구현</li>
    <li>알고리즘 검색 API 연결</li>
    <li>이미지 등록 및 서버와 연동</li>
  </ul>
</details>
<details>
